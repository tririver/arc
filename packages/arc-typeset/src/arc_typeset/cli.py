...
def main(argv: list[str] | None = None) -> int:
    ...
    translate_parser.add_argument("--model-tier", choices=["xhigh", "high", "medium", "low"], default=translate.DEFAULT_MODEL_TIER)
    ...
    batch_parser.add_argument("--model-tier", choices=["xhigh", "high", "medium", "low"], default=translate.DEFAULT_MODEL_TIER)
