...
class PromptProviderSummaryAdapter:
    def __init__(self, prompt_provider, *, env: Mapping[str, str] | None = None) -> None:
        self.prompt_provider = prompt_provider
        self.name = prompt_provider.name
        self.env = env
    ...
    def generate_summary(
        ...
        *,
        ...
        resolved_model = resolve_summary_model(self.name, model, env=self.env)
