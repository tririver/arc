...
def annotation_prompt(
    ...
    *,
    ...
    return (
        ...
        "derivation is not evident; (5) mention a materially useful current understanding or development only "
        "when it directly changes how this exact passage should be understood and is supported by registered, "
        "verifiable evidence. Do not chase novelty, treat a routine reformulation as progress, or rely on model "
        "memory for an update. Do not force all five directions into every segment and do not repeat the "
...
def review_prompt(payload: dict[str, Any], *, language: str, findings: list[Any] | None = None) -> str:
    ...
    return (
        ...
        "non-evident intermediate derivations, and materially useful current understanding or developments backed "
        "by registered, verifiable evidence. Do not chase novelty or relabel a routine reformulation as progress. "
...
def section_review_prompt(payload: dict[str, Any], *, language: str) -> str:
    return (
        ...
        "incompatibility, non-evident intermediate mathematics, or a materially useful current understanding or "
        "development backed by registered, verifiable evidence. Do not chase novelty or relabel a routine "
