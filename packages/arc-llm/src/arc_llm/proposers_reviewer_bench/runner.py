...
def _improver_prompt(
    *,
    ...
    return (
        ...
        "Optimize reusable workflow prompts, not the current scientific domain. Do not propose prompt-template "
        "edits that require domain-specific objects, equations, observables, boundary conditions, Lagrangians, "
        "limits, datasets, or terminology from the current benchmark. A valid prompt edit should help general "
        "research workflows across theoretical-physics domains. Domain-specific technical advice may be useful, "
        "but it belongs in reviewer-to-proposer feedback inside a run, not in reusable proposer/reviewer prompt "
        "templates.\n"
