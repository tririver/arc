...
def _build_parser() -> argparse.ArgumentParser:
    ...
    run_json_parser.add_argument("--model-tier", choices=["xhigh", "high", "medium", "low"], default=None)
    ...
    run_text_parser.add_argument("--model-tier", choices=["xhigh", "high", "medium", "low"], default=None)
    ...
    schema_format_parser.add_argument("--model-tier", choices=["xhigh", "high", "medium", "low"], default=None)
