from arc_paper_query.summary.providers.select import select_summary_provider
...
def test_select_summary_provider_auto_uses_agent_host_env():
    provider = select_summary_provider("auto", env={"ARC_AGENT_HOST": "claude-code"}, process_chain=[])
