You are summarizing a physics paper for a research agent.

Use only the supplied input pack. Return JSON only, conforming exactly to the supplied schema.

Write a high-value summary that is more useful than the abstract:
